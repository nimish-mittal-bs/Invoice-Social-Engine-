...
<div class='clear'>
  <div class='settings'>
    <form class="global_form">
      <div>
      <h3><?php echo $this->translate("Invoice Entry Categories") ?></h3>
      <p class="description">
        <?php echo $this->translate("Invoice_VIEW_SCRIPTS_ADMINSETTINGS_CATEGORIES_DESCRIPTION") ?>
      </p>
      ...
      <br/>
      <div class="tip">
      <span><?php echo $this->translate("There are currently no creators.") ?></span>
      </div>
      <?php endif;?>
      <br/>

      <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'invoice', 'controller' => 'settings', 'action' => 'add-category'), $this->translate('Add New Creator'), array(
